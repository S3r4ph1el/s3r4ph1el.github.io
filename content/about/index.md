...
- Elaboração de playbooks, metodologias e relatórios de inteligência cibernética (CTI)
- Implementação e orquestração de ambiente de ferramentas via Docker e Portainer
...
- Stack da empresa: React.js, Nest.js, Next.js, Prisma, TypeScript
- Premiado como "Membro Inovação" e outras condecorações internas por iniciativa
...
- Condecorações: Aspirante Apollo (destaque geral do ano), Melhor Aptidão Física, Melhor Conceito
