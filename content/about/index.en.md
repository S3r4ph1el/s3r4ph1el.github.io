...
- Development of playbooks, methodologies, and Cyber Threat Intelligence (CTI) reports
- Implementation and orchestration of tooling environment via Docker and Portainer
...
- Company stack: React.js, Nest.js, Next.js, Prisma, TypeScript
- Awarded "Innovation Member" and other internal recognitions for initiative
...
- Awards: Apollo Aspirant (overall highlight of the year), Best Physical Fitness, Best Academic Performance
...
- GitHub: [S3r4ph1el](https://github.com/S3r4ph1el)
- LinkedIn: [enzo-teles](https://linkedin.com/in/enzo-teles)
- Hack The Box: [Profile](https://app.hackthebox.com/public/users/2124077)
- Hacking Club: [Profile](https://app.hackingclub.com/profile/user/21053)
- Email: ezteles.px@gmail.com
